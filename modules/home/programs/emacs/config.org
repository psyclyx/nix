...
#+begin_src emacs-lisp
  ...
  (add-hook 'minibuffer-setup #'my/defer-gc)
  (add-hook 'minibuffer-exit #'my/restore-gc)
#+end_src
** Declutter
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (use-package perspective
    ...
    (persp-state-default-file
     (no-littering-expand-var-file-name "perspectives"))
    :config
  ...
  (use-package persp-projectile
    ...
    :config
    (define-key projectile-mode-map (kbd "C-c p p")
...
#+begin_src emacs-lisp
  (my-leader-def
    ...
    "TAB n" '(persp-new :which-key "new workspace")
    ...
    "TAB b" '(persp-switch-to-buffer :which-key "switch workspace buffer")
    "TAB p" '(projectile-persp-switch-project :which-key "switch project+workspace"))
#+end_src
** Git (=magit=)
#+begin_src emacs-lisp
  (use-package magit
...
#+begin_src emacs-lisp
  ...
  (use-package cider
    ...
    (my-local-leader-def
      ...
      "e" '("eval" . my/clojure-evaluation-map)
      "g" '("go" . my/clojure-navigation-map)
      "h" '("help" . my/clojure-help-map)
      "i" '("inspect" . my/clojure-inspect-map)
      "n" '("ns" . my/clojure-namespace-map)
      "p" '("pprint" . my/clojure-pprint-map)
      "r" '("repl" . my/clojure-repl-map)
      "t" '("test" . my/clojure-test-map))
