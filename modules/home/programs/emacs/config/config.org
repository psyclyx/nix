...
#+begin_src emacs-lisp
  ...
  ;; Set fallback font
  (set-fontset-font t nil "Hack Nerd Font Mono" nil 'append)
...
#+begin_src emacs-lisp
  (my-leader-def
    ...
    "ac" '(:ignore t :which-key "corsair")
    "acc" '(corsair-open-chat-buffer :which-key "open chat buffer")
    "aca" '(:ignore t :which-key "accumulate")
    "acac" '(corsair-accumulate-file-path-and-contents :which-key "file path and contents")
    "acan" '(corsair-accumulate-file-name :which-key "file name")
    "acap" '(corsair-accumulate-file-path :which-key "file path")
    "acav" '(corsair-accumulate-selected-text :which-key "selected text")
    "acad" '(corsair-drop-accumulated-buffer :which-key "drop")
    "acaf" '(corsair-insert-file-or-folder-contents :which-key "file/folder contents"))
#+end_src
** =direnv= & =envrc=
#+begin_src emacs-lisp
  (use-package direnv
